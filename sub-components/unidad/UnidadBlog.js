    ...
    return (
      <Dropdown>
        ...
        <Dropdown.Menu align={"end"}>
          <Dropdown.Item eventKey="1">Ver evento</Dropdown.Item>
          <Dropdown.Item eventKey="2">Nuevo evento</Dropdown.Item>
          <Dropdown.Item eventKey="3">Otra acción</Dropdown.Item>
        </Dropdown.Menu>
      </Dropdown>
    );
  };
        ...
        <Card.Body>
          <div className="d-flex justify-content-between mb-5 align-items-center">
            ...
            <div className="d-flex align-items-center">
              ...
              <div className="ms-3">
                <h5 className="mb-0 fw-bold">Buenos Aires</h5>
